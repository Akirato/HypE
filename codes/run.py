...
def main(args):
    ...
    if args.curvature < 0.22:
        raise ValueError('Curvature under bound. This will lead to errors.')
    ...
    logging.info('#curvature: %s' % args.curvature)
